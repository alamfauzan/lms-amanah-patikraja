    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800/80 rounded-2xl shadow-sm overflow-hidden">
            <div class="px-8 py-6 border-b border-slate-100 dark:border-slate-800">
                <h3 class="font-bold text-slate-800 dark:text-slate-100">Detail Pertemuan</h3>
            ...
            <form method="POST" action="{{ route('kelas.pertemuan.store', $kelas->id) }}" class="px-8 py-6 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" id="urutan" name="urutan" value="{{ old('urutan', 1) }}" min="1"
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3" placeholder="Deskripsi singkat tentang pertemuan ini..."
