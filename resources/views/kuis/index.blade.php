    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-bold text-lg text-slate-800 dark:text-slate-100">Daftar Kuis</h2>
                            ...
                            <div>
                                @if(auth()->user()->hasRole('siswa'))
                                    @if($attempt && $attempt->is_submitted)
                                        <div class="flex flex-col items-end gap-1">
                                            ...
                                            <a href="{{ route('kuis.hasil', [$kelas->id, $k->id]) }}"
                                    ...
                                    @else
                                        ...
                                        @else
                                            <a href="{{ route('kuis.show', [$kelas->id, $k->id]) }}"
                                ...
                                @else
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <a href="{{ route('kelas.kuis.edit', [$kelas->id, $k->id]) }}"
