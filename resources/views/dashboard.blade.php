<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-lg text-slate-800 dark:text-slate-205 leading-tight flex items-center gap-2">
            ...
            <span class="inline-flex items-center px-2 py-0.5 rounded bg-indigo-500/10 text-indigo-650 dark:text-indigo-400 text-[10px] font-extrabold uppercase tracking-wide">
