                ...
                @if(!empty($materi->file_path))
                    ...
                    @elseif($isPdf)
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="border border-slate-205 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm bg-white dark:bg-slate-950">
                                <iframe src="{{ asset('storage/' . $materi->file_path) }}" class="w-full h-[600px] border-0" type="application/pdf"></iframe>
                            </div>
                            <div class="p-4 bg-slate-50 dark:bg-slate-950 border border-slate-150 dark:border-slate-850 rounded-xl flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
                                <div class="min-w-0">
                                    <p class="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate">{{ basename($materi->file_path) }}</p>
